...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "vigilante-8-",
    .project_root_env = "VIGILANTE_8_RECOMP_PROJECT_ROOT",
    .build_dir_env = "VIGILANTE_8_RECOMP_BUILD_DIR",
    .force_setup_env = "VIGILANTE_8_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_012.12_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "vigilante_8__Recompiled",
    .prepare_note =
